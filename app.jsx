      ...
      <div className="hero-grid">
        <div className="hero-left">
          ...
          <p className="hero-sub">
            Et verksted for reparasjon, redesign og håndarbeid på{" "}
            <span className="addr">Maridalsveien&nbsp;154, Oslo</span>.
            Ta med plagget — vi har symaskinene, materialene og folkene.
          </p>
          <div className="hero-ctas">
            <a href="#schedule" className="btn btn-primary">Se kurs &amp; events</a>
            <a href="#services" className="btn btn-ghost">Bestill reparasjon →</a>
          </div>
        </div>
  ...
  return (
    <div className="navstrip">
      ...
      <nav className="nav-links">
        ...
        <a href="#picker">Hva tar du med?</a>
    ...
    <section className="services" id="services">
      <header className="section-head">
        ...
        <p className="section-lede">
          Stikk innom på Maridalsveien 154 — eller bestill på forhånd. Vi tar imot alt fra knappesøm til full redesign.
        </p>
      </header>
      ...
      <div className="partners-inner">
        ...
        <div className="partner-logos">
          <div className="logo-card">
            ...
            <div className="logo-tag">Re-commerce platform</div>
          </div>
          <div className="logo-card">
    ...
    <section className="visit" id="visit">
      <div className="visit-grid">
        <div className="visit-left">
          ...
          <p>0461 Oslo · Inngang fra bakgården, se etter den grønne sirkelen.</p>
          <dl className="hours">
            <div><dt>Man–Fre</dt><dd>10:00 — 18:00</dd></div>
            <div><dt>Lørdag</dt><dd>11:00 — 16:00</dd></div>
